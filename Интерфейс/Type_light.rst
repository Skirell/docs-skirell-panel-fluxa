...
- :ref:`param_1` — назначение блока (например, название устройства).
- :ref:`param_2` — локация или контекст использования.
- :ref:`setting_name` — название устройства в настройках.
- :ref:`icon` — иконка, отображаемая на блоке.
- :ref:`variant_type` — название типа(варианта) настроект блока.
- :ref:`variant` — объект с настройками тип(варианта) блока.
  - :ref:`Light_variant_OnOff` - тип вкл/выкл.
  - :ref:`light_variant_dimmer` - тип вкл/выкл, яркость.
  - :ref:`light_variant_temperature` - тип вкл/выкл, яркость, температура света.
  - :ref:`light_variant_color` - тип вкл/выкл, яркость, RGB цвет.
