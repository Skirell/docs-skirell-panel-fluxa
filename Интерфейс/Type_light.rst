...
- :ref:`setting_name` — название сценария или режима.
- :ref:`icon` — название сценария или режима.
- :ref:`variant_type` — название сценария или режима.
- :ref:`variant` — название сценария или режима.
