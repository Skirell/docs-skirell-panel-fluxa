...
fan_command_topic
*******************
   Командный MQTT-топик, куда отправляется сообщение с режимом скорости, установленным пользователем .
...
fan_state_topic
*******************
   MQTT-топик обратной связи, откуда приходит сообщение с режимом скорости, установленным устройством.
