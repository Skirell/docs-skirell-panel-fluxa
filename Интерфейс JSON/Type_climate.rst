...
Отправляет сообщение с режимом на командный MQTT-топик ``mode_command_topic``, а также отслеживает состояние устройства через MQTT-топик обратной связи ``mode_state_topic`` для обновления элементов интерфейса.
