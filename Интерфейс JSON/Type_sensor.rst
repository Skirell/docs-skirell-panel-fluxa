...
param_1
*******
   Используется для изменения текста названия в самом блоке, например, чтобы указать, что это тип датчика: «Температура» или «Влажность». Может применяться и в других целях.
